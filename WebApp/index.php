                    ...
                    <div class="banner-form">
                        <form class="form-inline">
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control " id="exampleInputAmount" placeholder="what would u like to eat..."> </div>
                            </div>
                            <button onclick="location.href='restaurants.html'" type="button" class="btn btn-info ">Search</button>
                        </form>
                    </div>
                    <div class="container text-center hero-text font-white">
                <!-- <h1>Discover the best food & drinks</h1>     -->
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="restaurant-listing">
						...
						// 												<div class="cost"><i class="fa fa-check"></i> Min Rs. 50</div>
                ...
                <div class="bottom-footer">
                    ...
                    <div class="col-xs-12 col-sm-3 payment-options color-gray">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                            <h5>Address</h5>
                            <p>near Surya Treasure Island Mall,
                            Nehru-nagar, Bhilai</p>
                            <h5>Phone: <a href="tel:+8319305246">8319305246</a></h5>
                        </div>
                        <div class="col-xs-12 col-sm-4 address color-gray">
                            <a href="#"> <img src="images/loc.png" alt="Image not avaliable for preview" > </a>
                        </div>
                    </div>
                </div>
                <!-- bottom footer ends -->
